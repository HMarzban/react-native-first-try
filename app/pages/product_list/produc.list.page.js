...
render() {
  ...
  const CatID = navigation.getParam('catID', 'tv');
          ...
          renderItem={({ item }) => (
            <View style={styles.row}>
              <TouchableOpacity
                ...
                onPress={this.btnNavigate.bind(Object.assign({ nav: this, item: item[0], catID: CatID }))}
              >
...
تومان
              ...
              <TouchableOpacity
                style={[styles.box, styles.box2]}
                onPress={this.btnNavigate.bind(Object.assign({ nav: this, item: item[1], catID: CatID }))}
              >
                <View style={styles.cholder}>
                  <View style={styles.holder}>
