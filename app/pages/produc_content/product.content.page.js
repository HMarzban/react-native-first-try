...
import {
  View, Text, StyleSheet, ScrollView, Image, AsyncStorage,
} from 'react-native';
...
export class ProductContent extends Component {
    ...
    async buyProduct() {
      try {
        const data = [];
        const value = JSON.parse(await AsyncStorage.getItem('BasketHolder'));
        if (value !== null) {
          let indexx = -1;
        ...
        // Error saving data
        console.log('Errr add product in Basket:', error);
      }
    } // @Function: buyProduct()
            ...
            <View style={[styles.section, styles.productCard]}>
              <View style={styles.holder}>
                <Image
                  ...
                  style={{
                    flex: 0.42, width: '100%', resizeMode: 'contain', height: 'auto',
                  }}
                />
